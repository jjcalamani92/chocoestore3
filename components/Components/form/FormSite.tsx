                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 lg:gap-6">
                    <div className="col-span-2">
                      <div>
                        ...
                        <input
                          className="my-2 focus:ring-rose-500 focus:border-rose-500 block w-full shadow-sm text-xs md:text-sm  rounded-md p-1 border border-gray-300"
                          type={"text"}
                          {...register('title', {
                            onChange: (e) => { },
                            onBlur: (e) => { },
                        ...
                        />
                        <div>
                          {errors.title && <span className="text-xs md:text-sm text-rose-500">{errors.title.message}</span>}
                        </div>
                      </div>
                      <div>
                        ...
                        />
                        <div>
                          {errors.address && <span className="text-xs md:text-sm text-rose-500">{errors.address.message}</span>}
                        </div>
                      </div>
                      <div className="grid grid-cols-1 gap 0 lg:grid-cols-2 lg:gap-3">
                        <div className="">
                          ...
                          />
                          <div>
                            {errors.domain && <span className="text-xs md:text-sm text-rose-500">{errors.domain.message}</span>}
                          </div>
                        </div>
                        <div className="">
                          ...
                          />
                          <div>
                            {errors.numberPhone && <span className="text-xs md:text-sm text-rose-500">{errors.numberPhone.message}</span>}
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="mt-1">
                          <textarea
                            rows={4}
                            className="shadow-sm focus:ring-rose-500 focus:border-rose-500 my-2 block w-full text-xs md:text-sm border border-gray-300 rounded-md p-1"
                      ...
                      <div>
                        ...
                        <div>
                          {errors.location && <span className="text-xs md:text-sm text-rose-500">{errors.location.message}</span>}
                        </div>
                      </div>
